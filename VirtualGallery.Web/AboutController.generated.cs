...
namespace VirtualGallery.Web.Controllers
{
    public partial class AboutController
    {
        ...
        public class ViewsClass
        {
            ...
            {
                public readonly string _AddPhotoButton = "_AddPhotoButton";
                public readonly string Index = "Index";
            }
            public readonly string _AddPhotoButton = "~/Views/About/_AddPhotoButton.cshtml";
            public readonly string Index = "~/Views/About/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AboutController : VirtualGallery.Web.Controllers.AboutController
    {
        ...
        [NonAction]
        partial void UploadOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, VirtualGallery.Web.Models.About.PhotoUploadButtonModel model);

        [NonAction]
        public override System.Web.Mvc.ActionResult Upload(VirtualGallery.Web.Models.About.PhotoUploadButtonModel model)
        {
